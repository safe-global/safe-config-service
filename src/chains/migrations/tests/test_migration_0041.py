...
class Migration0041TestCase(TestMigrations):
    migrate_from = "0040_chain_chain_logo_uri"
    migrate_to = "0041_chain_prices_provider_chain_name_and_more"
    ...
    def test_new_fields(self) -> None:
        ...
        self.assertEqual(chain.prices_provider_chain_name, None)
        self.assertEqual(chain.prices_provider_native_coin, None)
