...
class Chain(models.Model):
    ...
    safe_singleton_address = EthereumAddressField(null=True, blank=True)
    safe_proxy_factory_address = EthereumAddressField(null=True, blank=True)
    multi_send_address = EthereumAddressField(null=True, blank=True)
    multi_send_call_only_address = EthereumAddressField(null=True, blank=True)
    fallback_handler_address = EthereumAddressField(null=True, blank=True)
    sign_message_lib_address = EthereumAddressField(null=True, blank=True)
    create_call_address = EthereumAddressField(null=True, blank=True)
    simulate_tx_accessor_address = EthereumAddressField(null=True, blank=True)
